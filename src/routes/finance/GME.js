...
import GMElogo from '../../images/GME.JPG';

export default function GME() {
    const [configPrice, setconfigPrice] = React.useState("")

    const url = ['https://yh-finance.p.rapidapi.com/stock/v2/get-chart?interval=60m&symbol=GME&range=2y&region=US', 'GME']
    ...
    return (
        <div className="App">
            ...
            <div className='stockcontent'>
                ...
                <img src={GMElogo}/>
                <h4>About</h4>
                <p>GameStop Corp. is an American video game, consumer electronics, and gaming merchandise retailer. The company is headquartered in Grapevine, Texas, and is the largest video game retailer worldwide.</p>
                <p><b>CEO:</b> Matt Furlong (21 June 2021-)</p>
                <p><b>Founded:</b> 1984, Dallas, Texas, United States</p>
                <p><b>Number of employees:</b> 26,000 (2022)</p>
                <p><b>Revenue:</b> 6.01 billion USD (2021)</p>
                <p><b>Founders:</b> Gary M. Kusin, James McCurry</p>
                </div>
            </div>
        </div>
    );
