...
export default function TNX() {
    ...
    const url = ['https://yh-finance.p.rapidapi.com/stock/v2/get-chart?interval=60m&symbol=TNX&range=2y&region=US', 'TNX']

    const opts = {
        method: 'GET',
        headers: {
        'X-RapidAPI-Key': '4167133c86mshe27a1d1f80fdfedp1eaefdjsnc88690ace96a',
